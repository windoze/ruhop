...
- Test 05 (auto-reconnect) uses nftables or iptables rules to simulate network disruption (auto-detected, or configure `use_nftables` in `[common]` to select explicitly)
